...
| TD-10 | TFW-7 RF obs. | Low | `.tfw/glossary.md` L62 | Workflow definition says "Three canonical workflows" — refers to core lifecycle triad (plan, handoff, resume) | Accepted — core triad is accurate |
| TD-11 | TFW-7 RF obs. | Low | `.tfw/README.md` L280 | Evolution §v3 says "3 canonical workflows" — refers to core lifecycle triad | Accepted — core triad is accurate |
