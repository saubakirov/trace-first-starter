...
## Round 3 startup correction selection — 2026-09-23

Same Executor returned RF/EV at `0eb77dbe46ddd717fda05aecee35c6632a4abb41` after the Coordinator's F-R3/F-R4 rung-1 ruling at `3b200ac6ff7bef1101fdf7de424707909eae312a`. Replacement tested Candidate is `5ee5f190b23af43aa56039be1750d0fba3a7bd9d`; Baseline, approved TS selector and owner authority are unchanged. Select the 14 changed VALUE paths, especially shared `New-task startup card`, Plan Steps 1/5, three selected profile values, persistent adapter pointers and installed receiver parity. Check the card's entire safe-close claim against frozen HL §3.7 and TS AC-7/8/9, including common-only Cursor, not just the presence of eight numbered fields. Replay full Baseline→Candidate accounting and configured checks. Reuse earlier proof for the 24 unchanged VALUE paths and unaffected authority/safety boundaries. Owner Plan-text verdict and actual resource close remain reserved later effects.

## Round 4 residual F-R3 selection — 2026-09-23

The same Executor returned cumulative RF/EV at `b2082651cf3495abf10b8355abec8850cdbdbe02` under the Coordinator's existing rung-1 continuation at `37a2bff176e2076e2890748624623aa19ac42c5a`. Replacement tested Candidate is `e56874d88662b1d6ab67ea328ea99e74be7a98e2`; same Baseline, approved TS and owner denominator. Select only the shared startup card's safe-close item 8 in `.tfw/conventions.md`, its frozen HL §3.7/DoD 15 and shared close-rule meaning, plus affected Candidate identity, accounting and configured checks. Reuse Round 3 evidence for early timing, profile values, installed Plan parity and all unchanged VALUE. Owner Plan-text acceptance and actual final close remain separate open gates.
