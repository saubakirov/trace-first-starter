...
| Dependency | Status |
|------------|--------|
| Owner approval of this HL and a committed freeze before governed research | ✅ Approved and frozen; A1 re-freeze updates the role-launch mandate |
...
3. **Challenge:** test the smallest valid route on each provider, including a one-request Codex role launch and negative cases for transcript isolation, absent title support, missing browser access, and Section grouping scope.
