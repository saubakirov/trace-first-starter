...
| E8 | AC-8 | Same bounded native sequence was predeclared and attempted independently for Codex, Claude and Antigravity; P0–P4 and missing capabilities are separated; no composed/reliability claim | native Codex task tools and local provider CLIs | VERIFIED | [provider-native.md](provider-native.md) |
