...
6. The [repository test](../../../../../.tfw/scripts/test_gen_index.py) `test_the_repository_stateless_phases_are_all_informational` invokes `PROJECT_ROOT` and asserts six named starter tasks. It is evidence about this repository corpus, not a receiver-project capability gate.
