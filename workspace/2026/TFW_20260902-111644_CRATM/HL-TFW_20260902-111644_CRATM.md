...
> **Refreshed**: 2026-09-05 by Main Coordinator (Codex), after research iteration 3 and VBSA landing
...
| Reviewer      | A, B  | codex-judge   | coordinator | —               | visible task   |
```
...
└─ codex-judge.md     type: agent   accountable_to: saubakirov   may_rule_amendments: no
```
...
> Claude-native acceptance gate · 7. this HL §3.1
>
...
| R20. A request for a peer session is implemented as a nested subagent or an agent-definition file | High | High | A long-lived role passes eight observable gates, including provider-visible identity and direct addressability; a child behind a relay or a definition without a live identity fails before dispatch |
