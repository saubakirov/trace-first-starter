...
| **The approved contract was internally contradictory before any drift occurred.** TFW-49 §1 promised *"readable without special tooling"* and *"provenance, not decoration"*, while approved DoD-3 required *"a versioned structural validator"*, DoD-7 required repository fixtures across four roles and two surfaces, and DoF-8 made prose-only enforcement a failure condition. **Part of the scope the owner later rejected was a faithful reading of the DoD the owner approved.** No downstream role can defend a self-contradictory contract | iter2 Challenge C2 |
...
| The reference set is internally inconsistent and the check becomes a coin flip | Medium | High | Demonstrated on TFW-49's approved contract. Mitigation: amendment proposal A6 — a third outcome routing the contradiction to the owner as a *contract* defect, not a work defect |
