---
name: "source-command-tfw-update"
description: "TFW Update — upgrade project's .tfw/ from upstream starter"
---

# source-command-tfw-update

Use this skill when the user asks to run the migrated source command `tfw-update`.
...
| Codex | `.tfw/adapters/Codex/` | `AGENTS.md` |
